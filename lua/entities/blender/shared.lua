...
if SERVER then
	...
	local DrinkCombos = {
...

		{
			...
			Start = function( ply )
				...
				ply:ScreenFade( SCREENFADE.IN, Color( 255, 0, 0, 128 ), 1, 0 )
			
				ply:EmitSound( "vo/npc/male01/moan01.wav" )
			end,
...

		{
			...
			Start = function( ply )
				...
				GAMEMODE:SetPlayerSpeed( ply, 900, 1000 )
	...
	function ENT:EndSpitDrink()
		...
		if ( self.Drink ) then
			...
			local ent = ents.Create( "blender_drink" )
